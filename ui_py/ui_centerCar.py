...
class Ui_centerCar(object):
    def setupUi(self, centerCar):
        ...
        centerCar.setFrameShape(QFrame.StyledPanel)
        ...
        sizePolicy.setHeightForWidth(self.centerFloor.sizePolicy().hasHeightForWidth())
        self.centerFloor.setSizePolicy(sizePolicy)
        ...
        self.centerFloor.setFrameShape(QFrame.Box)
