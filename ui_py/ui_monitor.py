...
class Ui_monitor(object):
    def setupUi(self, monitor):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(270, 0, 16, 885))
        ...
        sizePolicy3.setHeightForWidth(self.frameInfo.sizePolicy().hasHeightForWidth())
        self.frameInfo.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.labelINSell.sizePolicy().hasHeightForWidth())
        self.labelINSell.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.labelOUTSell.sizePolicy().hasHeightForWidth())
        self.labelOUTSell.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.labelCNum.sizePolicy().hasHeightForWidth())
        self.labelCNum.setSizePolicy(sizePolicy4)
    ...
    def retranslateUi(self, monitor):
        ...
        self.label_6.setText(QCoreApplication.translate("monitor", u"\uc8fc\ucc28\ub300\uc218", None))
        self.labelParkingNum.setText(QCoreApplication.translate("monitor", u"48", None))
        self.label_8.setText(QCoreApplication.translate("monitor", u"\uacf5\ucc28\ub300\uc218", None))
        ...
        self.label.setText(QCoreApplication.translate("monitor", u"\uc785\uace0 SELL", None))
        self.labelINSell.setText(QCoreApplication.translate("monitor", u"XXXX", None))
        self.label_2.setText(QCoreApplication.translate("monitor", u"\ucd9c\uace0 SELL", None))
        self.labelOUTSell.setText(QCoreApplication.translate("monitor", u"XXXX", None))
